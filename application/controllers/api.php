...
class Api extends CI_Controller{
    ...
    public function login() {
        ...
        $result = $this->user_model->get(['login' => $this->input->post('login'),
    ...
    public function register() {
        ...
        $user_id = $this->user_model->insert(['login' => $this->input->post('login'),
                                           'password' => hash('sha256', $this->input->post('password').SALT),
...
// ------------------------------------------------------------------------
    ...
    public function get_todo($id = null){
        ...
        public function update_todo(){
            ...
            $this->_require_login();
            $result = $this->todo_model->update(['completed' => $this->input->post('completed'),
                                                'date_modified' => date('Y-m-d H:i:s')],
                                                                $this->input->post('todo_id'));
            if ($result) {
                $this->output->set_output(json_encode(['result' => 1]));
                return false;
            }
